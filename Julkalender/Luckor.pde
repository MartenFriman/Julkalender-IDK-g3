...
void lucka19 () {
  ...
  strokeWeight(2);
  stroke(249, 215, 47, 100);
  line(492, 273, 492, 308);
  line(506, 290, 477, 290);
  line(485, 282, 500, 299);
  line(500, 282, 485, 299);

  stroke(1);
  fill(124);
  rect(200, 450, 170, 100);
  triangle(283, 400, 166, 450, 400, 450);
  fill(249, 215, 47, 100);
  rect(210, 470, 50, 50);
  fill(0);
  line(235, 472, 235, 522);
  line(261, 495, 212, 495);

  fill(124);
  rect(350, 500, 170, 100);
  triangle(433, 450, 316, 500, 550, 500);
  fill(102, 51, 0, 200);
  rect(394, 561, 25, 40);
  fill(0);
  ellipse(401, 584, 5, 5);
  ...
  fill(124);
  rect(100, 550, 170, 100);
  triangle(183, 500, 66, 550, 300, 550);
  fill(249, 215, 47, 100);
  rect(117, 581, 30, 40);
  rect(178, 581, 30, 40);
  fill(0);
  line(132, 583, 132, 622);
  line(118, 599, 148, 599);
  line(194, 583, 194, 622);
  line(180, 599, 208, 599);
  fill(102, 51, 0);
  rect(315, 667, 20, 25); 
  ...
  noStroke();
  fill(0, 102, 51);
  triangle(285, 570, 325, 530, 360, 570);
  triangle(321, 563, 387, 603, 255, 603);
  triangle(323, 580, 395, 628, 245, 628);
  triangle(324, 600, 235, 672, 410, 670);
}
...
void lucka23(){
  ...
  noStroke();
  fill(102, 51, 0);
  rect(350, 690, 100, 100, 0, 0, 20, 20);
  fill(0);
  rect(340, 750, 120, 40, 10);
  fill(0, 102, 51);
  triangle(400, 100, 200, 300, 600, 300);
  triangle(400, 200, 150, 500, 650, 500); 
  triangle(400, 300, 100, 700, 700, 700);
  ...
  triangle(400, 102, 422, 85, 445, 130);
  line(342, 57, 381, 76);
  line(356, 129, 389, 95);
  line(445, 131, 413, 94); 
  line(420, 76, 458, 56);
